...
export default function Contact() {
  return (
    <div className="min-h-screen flex flex-col selection:bg-cyan-400 selection:text-black">
      {/* Hero Section */}
      <section className="relative overflow-hidden py-10 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0A3D62] via-[#0A3D62]/80 to-[#00AEEF] text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold mb-3 sm:mb-5">
              Get In <span className="text-cyan-400">Touch</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-neutral-200 mb-6 sm:mb-8">
            ...
            <Link
              href="#contact-form"
              className="inline-flex w-full sm:w-auto items-center justify-center px-6 sm:px-8 py-3 bg-cyan-500 hover:bg-cyan-400 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
            >
              Contact Us
            </Link>
          </motion.div>
      ...
      {/* Contact Methods */}
      <section className="py-10 sm:py-14 px-4 sm:px-6 lg:px-8 bg-neutral-50">
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-primary-950 mb-3 sm:mb-4">
              How Can We Help?
            </h2>
            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                <motion.a
                  ...
                  className="card p-6 text-center group hover:shadow-xl transition-all duration-300 rounded-xl bg-white"
                >
                  <div
                    className={`w-14 h-14 sm:w-16 sm:h-16 ${method.color} rounded-xl flex items-center justify-center mx-auto mb-3`}
                  >
      ...
      {/* Contact Form */}
      <section id="contact-form" className="py-10 sm:py-14 px-4 sm:px-6 lg:px-8">
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-primary-950 mb-3">
              Send Us a Message
            </h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
      ...
      <section className="py-10 sm:py-14 px-4 sm:px-6 lg:px-8 bg-neutral-50">
        <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          {/* Office Info */}
          <motion.div
          ...
          >
            ...
            <div className="space-y-4 text-sm sm:text-base">
              ...
              <div className="flex items-start space-x-2">
                <Clock className="w-4 h-4 text-secondary-500 mt-0.5" />
                <p className="text-neutral-600">
              ...
              <div className="flex items-start space-x-2">
                <ShieldCheck className="w-4 h-4 text-secondary-500 mt-0.5" />
                <p className="text-neutral-600">
                  Secure contracts and NDAs ensure confidentiality and compliance with <strong>GDPR & international standards</strong>.
                </p>
              </div>
            </div>
          </motion.div>
